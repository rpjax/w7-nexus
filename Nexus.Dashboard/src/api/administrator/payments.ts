...
export async function searchAdministratorPayments(payload: AdminPaymentSearchRequest) {
  return apiClient.post<SearchResponse<PaymentRow>>('/api/payments/administrator/search', {
    Limit: payload.limit,
...
export async function getAdministratorPayment(paymentId: string) {
  return apiClient.get<PaymentRow>(`/api/payments/administrator/${encodeURIComponent(paymentId)}`, {
    fallbackError: 'Não foi possível carregar o pagamento.',
  });
}

export async function payAdministratorPayment(paymentId: string) {
  return apiClient.post<PaymentRow>(`/api/payments/administrator/${encodeURIComponent(paymentId)}/pay`, {}, {
...
export async function refundAdministratorPayment(paymentId: string) {
  return apiClient.post<PaymentRow>(`/api/payments/administrator/${encodeURIComponent(paymentId)}/refund`, {}, {
...
export async function killAdministratorPayment(paymentId: string, reason: string) {
  return apiClient.post<PaymentRow>(`/api/payments/administrator/${encodeURIComponent(paymentId)}/kill`, {
    Reason: reason,
  }, { fallbackError: 'Não foi possível cancelar o pagamento.' });
}

export async function deleteAdministratorPayment(paymentId: string) {
  return apiClient.delete(`/api/payments/administrator/${encodeURIComponent(paymentId)}`, {
...
export async function bindAdministratorPaymentOperator(paymentId: string, operatorId: string) {
  return apiClient.post<PaymentRow>(`/api/payments/administrator/${encodeURIComponent(paymentId)}/bind-operator`, {
...
export async function bindAdministratorPaymentStrawMan(paymentId: string, strawManId: string) {
  return apiClient.post<PaymentRow>(`/api/payments/administrator/${encodeURIComponent(paymentId)}/bind-straw-man`, {
...
export async function markAdministratorPaymentDistributed(paymentId: string) {
  return apiClient.post<PaymentRow>(`/api/payments/administrator/${encodeURIComponent(paymentId)}/mark-distributed`, {}, {
