...
using AdminAssignOperatorToTeamRequest = Nexus.Administrator.Application.Requests.AssignOperatorToTeamRequest;
using AdminSearchOperatorsToAssignRequest = Nexus.Administrator.Application.Requests.SearchOperatorsToAssignRequest;
using Nexus.Authorization;
using TeamLeaderSearchOperatorsToAssignRequest = Nexus.TeamLeader.Application.Requests.SearchOperatorsToAssignRequest;
using Nexus.Tests.Support;
using Xunit;

namespace Nexus.Tests.Administrator;
