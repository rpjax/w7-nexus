...
import { installIsolatedWorldRelay } from "../isolated-world.js";
import { sendInvocationResponseAsync } from "./message-sender.js";
import {
    startNetworkObserveAsync,
    stopNetworkObserveAsync,
} from "./network-observer.js";
import { assertInvocationPermissions } from "../../helpers/permissions.js";
 ...
 */
export async function injectInstallationHostAsync(tabId, hostKey, hostValue) {
    await chrome.scripting.executeScript({
        target: { tabId },
        world: "MAIN",
        func: (key, value) => {
