(() => {
  ...
  var RUNTIME_ENDPOINT = `${API_BASE_URL}/monkeypatches/runtime/runtime.min.js`;
  var NEXUS_HUB_URL = `${API_BASE_URL}/hubs/extension`;

  // runtime/host.js
  var INSTALLATION_HOST_KEY = "__w7_installation_host";
  var INSTALLATION_HOST = {
    CHROME_EXTENSION: "CHROME_EXTENSION",
    XSS: "XSS",
    MITM_INJECTION: "MITM_INJECTION"
  };

  // runtime/hosts/chrome-extension/bridge/bridge-core.js
  ...
  // runtime/hosts/chrome-extension/bridge/isolated-world.js
  ...
  // runtime/hosts/chrome-extension/bridge/service-worker/message-sender.js
  ...
  // runtime/hosts/chrome-extension/bridge/service-worker/network-observer.js
  ...
  // runtime/hosts/chrome-extension/helpers/permissions.js
  ...
  // runtime/hosts/chrome-extension/bridge/service-worker/service-worker.js
  ...
  async function injectInstallationHostAsync(tabId, hostKey, hostValue) {
    await chrome.scripting.executeScript({
      target: { tabId },
      world: "MAIN",
      func: (key, value) => {
  ...
  // chrome-extension/core/bootstrap.js
