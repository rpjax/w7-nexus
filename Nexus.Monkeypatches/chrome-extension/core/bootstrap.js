...
import {
    ...
    injectInstallationHostAsync,
    injectRuntimeInMainWorldAsync,
    installIsolatedBridgeAsync,
} from "../../runtime/hosts/chrome-extension/bridge/service-worker/service-worker.js";
import { clearTabWatches } from "../../runtime/hosts/chrome-extension/bridge/service-worker/network-observer.js";
...
async function installRuntimeAsync(tabId, generation) {
    ...
    await injectInstallationHostAsync(tabId, INSTALLATION_HOST_KEY, INSTALLATION_HOST.CHROME_EXTENSION);
