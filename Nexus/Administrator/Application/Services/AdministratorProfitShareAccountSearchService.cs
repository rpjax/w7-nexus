...
public sealed class AdministratorProfitShareAccountSearchService : IAdministratorProfitShareAccountSearchService
{
    private const int SearchKeywordMaxLength = 200;

    private IAccountRepository _accounts { get; }

    public AdministratorProfitShareAccountSearchService(IAccountRepository accounts)
    {
        _accounts = accounts;
    }
