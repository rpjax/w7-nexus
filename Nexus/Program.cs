...
builder.Services.AddScoped<IAdministratorAccessPolicy, AdministratorAccessPolicy>();
builder.Services.AddScoped<IRequesterIdentityResolver, Nexus.Authorization.Application.Services.RequesterIdentityResolver>();
builder.Services.AddScoped<IOperationAdministratorAccessPolicy, OperationAdministratorAccessPolicy>();
builder.Services.AddScoped<IOperationAdministratorOperationSearchService, OperationAdministratorOperationSearchService>();
builder.Services.AddScoped<IOperationAdministratorAccountSearchService, OperationAdministratorAccountSearchService>();
builder.Services.AddScoped<IOperationAdministratorTeamCommandService, OperationAdministratorTeamCommandService>();
builder.Services.AddScoped<IOperationAdministratorTeamLeaderCandidateSearchService, OperationAdministratorTeamLeaderCandidateSearchService>();
builder.Services.AddScoped<IOperationAdministratorStrawManAssignmentSearchService, OperationAdministratorStrawManAssignmentSearchService>();
builder.Services.AddScoped<IOperationAdministrator, OperationAdministrator>();
builder.Services.AddScoped<ITeamLeaderAccessPolicy, TeamLeaderAccessPolicy>();
builder.Services.AddScoped<IOperatorAccessPolicy, OperatorAccessPolicy>();
builder.Services.AddScoped<IOperatorOperationSearchService, OperatorOperationSearchService>();
...
builder.Services.AddScoped<IAdministratorOperationSearchService, AdministratorOperationSearchService>();
builder.Services.AddScoped<IAdministratorAccountSearchService, AdministratorAccountSearchService>();
builder.Services.AddScoped<IAdministratorOperationCommandService, AdministratorOperationCommandService>();
builder.Services.AddScoped<IAdministratorTeamCommandService, AdministratorTeamCommandService>();
builder.Services.AddScoped<IAdministratorTeamOperatorCommandService, AdministratorTeamOperatorCommandService>();
builder.Services.AddScoped<IAdministratorOperatorAssignmentSearchService, AdministratorOperatorAssignmentSearchService>();
builder.Services.AddScoped<IAdministratorProfitShareAccountSearchService, AdministratorProfitShareAccountSearchService>();
builder.Services.AddScoped<ITeamLeaderLedTeamsSearchService, TeamLeaderLedTeamsSearchService>();
builder.Services.AddScoped<ITeamLeaderTeamCommandService, TeamLeaderTeamCommandService>();
builder.Services.AddScoped<ITeamLeaderOperatorAssignmentSearchService, TeamLeaderOperatorAssignmentSearchService>();
builder.Services.AddScoped<ITeamLeaderProfitShareAccountSearchService, TeamLeaderProfitShareAccountSearchService>();
builder.Services.AddScoped<IAdministrator, Administrator>();
builder.Services.AddScoped<Nexus.Administrator.Application.Contracts.ITeamGatewayDetailsLoader, Nexus.Administrator.Application.Services.TeamGatewayDetailsLoader>();
builder.Services.AddScoped<Nexus.OperationAdministrator.Application.Contracts.ITeamGatewayDetailsLoader, Nexus.OperationAdministrator.Application.Services.TeamGatewayDetailsLoader>();
