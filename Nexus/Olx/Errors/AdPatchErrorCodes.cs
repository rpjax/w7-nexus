...
public static class AdSpoofErrorCodes
{
    ...
    public const string AdUrlInvalid = "Olx.AD_URL_INVALID";
    public const string OperatorIdInvalid = "Olx.OPERATOR_ID_INVALID";
    public const string OperatorNotFound = "Olx.OPERATOR_NOT_FOUND";
    public const string OperatorRoleRequired = "Olx.OPERATOR_ROLE_REQUIRED";
    ...
    public const string SearchLimitInvalid = "Olx.SEARCH_LIMIT_INVALID";
    public const string SearchOffsetInvalid = "Olx.SEARCH_OFFSET_INVALID";
    public const string SearchKeywordTooLong = "Olx.SEARCH_KEYWORD_TOO_LONG";
}
